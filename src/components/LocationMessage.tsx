...
export const LocationMessage: React.FC<LocationMessageProps> = ({
  ...
  if (isCurrentUser) {
    // 当前用户的位置消息：消息靠右，头像在最右侧
    return (
      <div className="flex items-end justify-end space-x-2">
        {/* 位置消息内容 */}
        <div className="max-w-xs rounded-lg overflow-hidden bg-[#95EC69]">
          {/* 地图预览区域 */}
  ...
  return (
    <div className="flex items-end space-x-2">
      ...
      {/* 位置消息内容 */}
      <div className="max-w-xs rounded-lg overflow-hidden bg-white border border-gray-200">
        {/* 发送者名称 */}
        {participant && (
